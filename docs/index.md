...
the sRGB gamut, and every contrast target on this site — 14 of them, in each
mode. It prints each ratio whether it passes or not, because a pass/fail line
tells you less than the numbers do.
